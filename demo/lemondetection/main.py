...
def main():
    ...
    nn = NeuralNet(num_features, max_epochs=10, learn_rate=.7, scale=0.1, 
                   hidden_layer=[4], verbose=True)
    print nn.weights1.size[0]
    print nn.weights1.size[1]
    print nn.weights2.size[0]
    print nn.weights2.size[1]
